...
const StaffReviewsPage = () => {
  ...
  return (
    <div className='container mx-auto flex h-full w-full gap-2 flex-col justify-start p-6'>
      <div className='mb-2'>
        <h1 className='text-2xl font-bold'>Team Weekly Reports Review</h1>
        <p className='text-sm text-muted-foreground'>
          Inspect submissions, review velocity, approve reports, or request changes
        </p>
      </div>
      <DataTable
